    ...
    <div class="selectDisplay">
      ...
      <a-dropdown>
        <a
          ...
          style="font-size: 16px; color: #67758d"
        >
...
export default {
  ...
  computed: {
    ...mapGetters(["historyVisible", "graphDetailsVisible","filterByNodeLabelsVisible"]),
  },
  mounted() {
    // Cxtmenu圆形菜单主要依赖组件
  ...
  methods: {
    ...
    ...mapMutations(["set_historyVisible", "set_graphDetailsVisible","set_filterByNodeLabelsVisible"]),
    ...mapActions(["getHistoryList", "getGraphDetailsList"]),
    showHistory() {
      this.getHistoryList();
