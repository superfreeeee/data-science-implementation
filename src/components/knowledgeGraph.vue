...
<template>
  ...
  <div class="drawer">
    ...
    <addEdge
      :sourceId="this.from"
      :targetId="this.to"
      @listenToAddedEdge="getEdgeData"
    ></addEdge>
    <modifyEdge
      :edge="this.edgeData"
      @listenToModifiedEdge="getModifiedEdge"
    ></modifyEdge>
    <addNode
      :posX="this.posX"
      :posY="this.posY"
      @listenToAddedNode="getNodeData"
    ></addNode>
    <modifyNode
      :node="this.nodeData"
      @listenToModifiedNode="getModifiedNode"
    ></modifyNode>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    ...mapMutations([
      'set_addEdgeFormVisible',
      'set_modifyEdgeFormVisible',
      'set_edgeId',
      'set_nodeId',
      'set_addNodeFormVisible',
      'set_modifyNodeFormVisible',
      'set_nodeProperties',
    ]),
    // 添加元素
    addEles(eles) {
