      ...
      <a-menu theme="dark" :default-selected-keys="['1']" mode="inline">
        ...
        <a-sub-menu>
          ...
          <a-sub-menu v-for="(value, key) in nodeList" :key="key">
            <span slot="title"
              ><a-icon type="user" /><span>{{ key }}</span></span
            >
            <a-sub-menu v-for="(value1, key1) in value" :key="key + key1">
              <span slot="title"
                ><a-icon type="user" /><span>{{ key1 }}</span></span
              >
              <a-sub-menu
              ...
              >
                <span slot="title"
                  ><a-icon type="user" /><span>{{ key2 }}</span></span
                >
                <a-menu-item
                  v-for="item in value2"
                  :key="key + key1 + key2 + item"
        ...
        <div :style="{ padding: '24px', minHeight: '360px' }">
          <div style="height: 100%; width: 100%">
            ...
            <div class="propertyDisplay">
              <span id="labels"></span>
              <pre id="properties">
 click on the node or edge to display more infomation!</pre
              >
            </div>
...
import semanticsS from "./semanticsS";
